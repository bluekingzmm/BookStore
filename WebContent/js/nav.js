...
var setMainNav = function () {
	...
	var aGameHover = getByClass(oMainNav, "book_hover");
	...
	for (var i = 0; i < aGameHover.length; i++) {
		...
		aGameHover[i].onmouseover = function () {
			this.className += " "+"book_hover_current";
			for (var j = 0; j < aHoverCont.length; j++) {
				...
				aHoverCont[j].onmouseover = function () {
					...
					aGameHover[this.index_j].className += " "+"book_hover_current";
				}
	...
	for (var i = 0; i < aLi.length; i++) {
		...
		aLi[i].onmouseout = function () {
			...
			aGameHover[this.index].className = "book_hover";
		}
	}
}
