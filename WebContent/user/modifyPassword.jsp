...
<div class="panel admin-panel">
  <div class="panel-head"><strong>欢迎您：${sessionScope.user.name}&nbsp;&nbsp;&nbsp;&nbsp;<span class="icon-key"></span> 修改密码</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="<%=request.getContextPath()%>/UserAction?operato=changePsw" >
